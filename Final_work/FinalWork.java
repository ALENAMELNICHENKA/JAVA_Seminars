...
public class FinalWork {
    public static void main(String[] args) {
        Notebook notebook1 = new Notebook("Asus", "16", "1000", "Windows", "grey");
        Notebook notebook2 = new Notebook("Asus", "32", "1000", "Linux", "black");
        Notebook notebook3 = new Notebook("Asus", "64", "2000", "Windows", "black");
        Notebook notebook4 = new Notebook("Asus", "16", "1000", "Windows", "grey");
        Notebook notebook5 = new Notebook("Huawei", "32", "1000", "Windows", "black");
    ...
    public static Map<String, String> selectCriteria() {
        ...
        while (true) {
            System.out.println("Для выбора критерия введите 'y', если нет введите 'n'");
